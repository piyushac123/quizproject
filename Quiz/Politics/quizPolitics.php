...
<HTML>
    ...
    <BODY>
        <?php
            ...
            $dat = file_get_contents('../Questions/Politics.txt');
                $cntline = 0;
                foreach(explode("\n",$dat) as $rec){
                    $cntline++;
                }
...
//            }
        ...
        <div class="container-fluid bg-primary">
            <div class="row">
                <div class="col-sm-12">
                    <span class="title">Political India</span>
                </div>
            </div>
        </div>
        <hr>
...
-->
        ...
        <hr>
        <form  id="myForm1" method="post" action="submitPolitics.php" class="link1">
        <div id="section1">
...
//              if(s==59){m=m-1}
//              if(m==0&&s==0){
//                  alert('Quiz submitted automatically.');
//                    //window.location.href="#";
